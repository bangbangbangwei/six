...
public class Fragmenttwo_One extends BaseFragment {

    private PullToRefreshListView plv;
    String path = "http://172.17.8.100/movieApi/movie/v1/findHotMovieList?page=";
    int page;
    ...
    public int getLayout() {
        return R.layout.fragmenttwo_one;
    }
